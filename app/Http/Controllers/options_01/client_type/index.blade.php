...
@endsection
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.Client_type')}}</p>
@endsection
@section('btnTable')
<div class="mb-1">
...
<!-- modal -->
@include('options_01.client_type.create')
@include('options_01.client_type.edit')
@endsection
@section('js')
<!-- DataTables  & Plugins -->
...
$(document).ready(function() {
    ...
    $("#menu_client_type").addClass("active");
    <?php 
    ...
    $("#example1").DataTable({
        ...
        columns: [{
            ...
            {
                data: 'clienttype_name_kh',
                name: 'clienttype_name_kh',
            },
            {
                data: 'clienttype_name_en',
                name: 'clienttype_name_en',
            },
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#e_clienttype_name_kh').val(data.clienttype_name_kh)
                $('#e_clienttype_name_en').val(data.clienttype_name_en)
