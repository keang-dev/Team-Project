...
<!-- modal -->
@include('options_01.delegation.create')
@include('options_01.delegation.edit')
...
$(document).ready(function() {
    ...
    $("#menu_delegation").addClass("active");
    ...
    $("#example1").DataTable({
        ...
        columns: [{
            ...
            {
                data: 'delegation_name_kh',
                data: 'delegation_name_kh',
            },
            {
                data: 'delegation_name_en',
                data: 'delegation_name_en',
            },
            {
                data: 'delegation_qrcode',
                data: 'delegation_qrcode',
                searchable: false,
                orderable: false
            },
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#d_delegation_name_kh').val(data.delegation_name_kh)
                $('#d_delegation_name_en').val(data.delegation_name_en)
