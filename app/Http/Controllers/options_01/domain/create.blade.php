...
<div class="modal fade" id="createModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <form action="#" id="formSave" class="modal-dialog" method="post" onsubmit="saveForm(event)">
        @csrf
        <input type="hidden" name="entity" value="domains">
        <input type="hidden" name="unique_col" value="domain_name_kh">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class=" form-group">
                            ...
                            <input type="text" name="domain_name_kh" class="form-control" required
                                placeholder="បញ្ចូលឈ្មោះជាអក្សរខ្មែរ ">
                        </div>
                        <div class="form-group">
                            <label>{{__('t.name en')}} <span class="text-danger"></span></label>
                            <input type="text" name="domain_name_en" class="form-control"
