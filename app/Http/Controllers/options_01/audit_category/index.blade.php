...
<!-- modal -->
@include('options_01.audit_category.create')
@include('options_01.audit_category.edit')
...
$(document).ready(function() {
    ...
    $("#menu_audit_category").addClass("active");
    ...
    $("#example1").DataTable({
        ...
        "searching": false,
        ajax: {
            url: "{{ route('audit_category.index') }}",
            type: 'get',
            data: function(d) {
        ...
        columns: [{
            ...
            {
                data: 'auditcategory_name_en',
                name: 'auditcategory_name_en',
            },
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#e_auditcategory_name_kh').val(data.auditcategory_name_kh)
                $('#e_auditcategory_name_en').val(data.auditcategory_name_en)
