...
@endsection
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.Audit QA')}}</p>
@endsection
@section('btnTable')
<div class="mb-1">
...
<!-- modal -->
@include('options_01.audit_qa.create')
@include('options_01.audit_qa.edit')
@endsection
@section('js')
<!-- DataTables  & Plugins -->
...
$(document).ready(function() {
    ...
    $("#example1").DataTable({
        ...
        columns: [{
            ...
            {
                data: 'auditqa_name_en',
                name: 'auditqa_name_en',
            },
            {
                data: 'action',
                data: 'action',
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#e_auditqa_name_kh').val(data.auditqa_name_kh)
                $('#e_auditqa_name_en').val(data.auditqa_name_en)
