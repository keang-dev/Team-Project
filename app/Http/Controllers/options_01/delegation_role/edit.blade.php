<div class="modal fade" id="editModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <form action="#" id="formUpdate" class="modal-dialog" method="post" onsubmit="updateForm(event)">
        @csrf
        <input type="hidden" name="entity" value="delegation_roles" required>
        <input type="hidden" name="id" id="id" required>
        <input type="hidden" name="up_by" value="{{auth()->user()->id}}">
        <div class="modal-content">
            <div class="modal-header bg-green">
                <h5 class="modal-title titleTable text-white" id="editModalLabel">តំណែទំរង់ {{__('t.delegation role')}} </h5>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="delegationrole_name_kh" id="d_delegationrole_name_kh"
                                class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="phone_name_en">ឈ្មោះជាអក្សរអង់គ្លេស <span class="text-danger">*</span></label>
                            <input type="text" name="delegationrole_name_en" id="d_delegationrole_name_en"
                                class="form-control" required>
                        </div>
                    </div>
                </div>
