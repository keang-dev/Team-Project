<div class="modal fade" id="editModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <form action="#" id="formUpdate" class="modal-dialog" method="post" onsubmit="updateForm(event)">
        @csrf
        <input type="hidden" name="entity" value="audit_pfms" required>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="auditreportpfm_id">{{__('t.auditreportpfm_id')}} <span
                                    class="text-danger"></span></label>
                            <select name="auditreportpfm_id" id="e_auditreportpfm_id" class="form-control" required>
                                <option value="">-----</option>
