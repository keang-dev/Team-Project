...
@section('tab-title')
<title>{{__('t.client organization contact')}}</title>
@endsection
@section('css')
<!-- DataTables -->
...
@endsection
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.client organization contact')}}</p>
@endsection
@section('btnTable')
<div class="mb-1">
        ...
        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
            ...
            <thead>
                <tr class="listTable">
                    ...
                    <td>{{__('t.client_organization_name')}}</td>
...
<!-- modal -->
@include('options_02.client_organization_contact.create')
@include('options_02.client_organization_contact.edit')
@endsection
@section('js')
<!-- DataTables  & Plugins -->
...
$(document).ready(function() {
    ...
    $("#menu_client_organization_contact").addClass("active");
    <?php 
    ...
    $("#example1").DataTable({
        ...
        "searching": false,
        ajax: {
            url: "{{route('client.organization.contact.index')}}",
            type: 'get',
            data: function(d) {
...
function setDefault(id, e) {
    ...
    $.ajax({
        ...
        data: {
            entity: 'client_organization_contacts',
            id: id,
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#e_client_organization_name').val(data.client_organization_name)
