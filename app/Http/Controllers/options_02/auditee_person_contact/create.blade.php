...
<div class="modal fade" id="createModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <form action="#" id="formSave" class="modal-dialog" method="post" onsubmit="saveForm(event)">
        @csrf
        <input type="hidden" name="entity" value="auditee_person_contacts">
        <input type="hidden" name="unique_col" value="auditeecontact_name">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label>{{__('t.auditeeperson_id')}} <span class="text-danger"></span></label>
                            <select name="auditeeperson_id" class="form-control" required>
                                <option value="">-----</option>
                        ...
                        <div class="form-group">
                            <label>{{__('t.auditeepersontype_id')}} <span class="text-danger"></span></label>
                            <select name="auditeepersontype_id" class="form-control" required>
                                <option value="">-----</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="auditeecontact_name" class="form-control" required>
                        </div>
