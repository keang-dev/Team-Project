                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <select name="auditqa_id" class="form-control" required>
                                <option value="">-----</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="audit_qareview_by" class="form-control" required>
                                <option value="">-----</option>
                                @foreach($staffs as $c)
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="audit_qareview_date" class="form-control"
