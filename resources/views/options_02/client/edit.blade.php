<div class="modal fade" id="editModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <form action="#" id="formUpdate" class="modal-dialog" method="post" onsubmit="updateForm(event)">
        @csrf
        <input type="hidden" name="entity" value="clients" required>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="client_name_kh">{{__('t.name kh')}} <span class="text-danger"></span></label>
                            <input type="text" name="client_name_kh" id="e_client_name_kh" class="form-control"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="client_name_en">{{__('t.name en')}} <span class="text-danger"></span></label>
                            <input type="text" name="client_name_en" id="e_client_name_en" class="form-control">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="clienttype_id" id="e_clienttype_id" class="form-control" required>
                                <option value="">-----</option>
                                @foreach($client_types as $c)
                                <option value="{{$c->id}}">{{$c->clienttype_name_kh}}</option>
                                @endforeach
                            </select>
                        </div>
