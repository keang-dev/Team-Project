...
@endsection
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.Audit PFM')}}</p>
@endsection
@section('btnTable')
<div class="mb-1">
...
<!-- modal -->
@include('options_02.audit_pfm1.create')
@include('options_02.audit_pfm1.edit')
@endsection
@section('js')
<!-- DataTables  & Plugins -->
...
$(document).ready(function() {
    ...
    $("#menu_audit_pfm").addClass("active");
    <?php 
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#e_auditreportpfm_id').val(data.auditreportpfm_id)
