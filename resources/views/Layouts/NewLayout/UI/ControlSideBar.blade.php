<aside class="control-sidebar control-sidebar-dark" style="display: block; top: 56.9034px; height: 531.097px;">
    ...
    <div class="p-3 control-sidebar-content" style="">
        ...
        <div class="d-flex"><select class="custom-select mb-3 text-light border-0 bg-indigo">
