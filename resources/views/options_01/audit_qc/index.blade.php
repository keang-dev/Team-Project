...
@endsection
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.Audit QC')}}</p>
@endsection
@section('btnTable')
<div class="mb-1">
...
<!-- modal -->
@include('options_01.audit_qc.create')
@include('options_01.audit_qc.edit')
@endsection
@section('js')
<!-- DataTables  & Plugins -->
...
$(document).ready(function() {
    ...
    $("#example1").DataTable({
        ...
        columns: [{
            ...
            {
                data: 'auditqc_name_en',
                name: 'auditqc_name_en',
            },
            {
                data: 'action',
                data: 'action',
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#e_auditqc_name_kh').val(data.auditqc_name_kh)
                $('#e_auditqc_name_en').val(data.auditqc_name_en)
