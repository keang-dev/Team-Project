...
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.Audit Time')}}</p>
...
<!-- modal -->
@include('options_01.audit_time.create')
@include('options_01.audit_time.edit')
...
$(document).ready(function() {
    ...
    $("#menu-table>a").addClass("active"); // parrent menu
    $("#menu_table").addClass("menu-open");
    $("#menu_audit_time").addClass("active");
    <?php 
    ...
    $("#example1").DataTable({
        ...
        columns: [{
            ...
            {
                data: 'audittime_name_en',
                name: 'audittime_name_en',
            },
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#e_audittime_name_kh').val(data.audittime_name_kh)
                $('#e_audittime_name_en').val(data.audittime_name_en)
