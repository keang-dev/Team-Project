...
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.Audit Std')}}</p>
...
<!-- modal -->
@include('options_01.audit_std.create')
@include('options_01.audit_std.edit')
...
$(document).ready(function() {
    ...
    $("#menu_audit_std").addClass("active");
    <?php 
    ...
    $("#example1").DataTable({
        ...
        columns: [{
            ...
            {
                data: 'auditstd_name_en',
                name: 'auditstd_name_en',
            },
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#e_auditstd_name_kh').val(data.auditstd_name_kh)
                $('#e_auditstd_name_en').val(data.auditstd_name_en)
