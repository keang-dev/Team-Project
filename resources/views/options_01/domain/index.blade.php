...
@endsection
@section('titleTable')
<p class="titleTable">តារាងគ្រប់គ្រង{{__('t.Domain')}}</p>
@endsection
@section('btnTable')
<div class="mb-1">
...
<!-- modal -->
@include('options_01.domain.create')
@include('options_01.domain.edit')
@endsection
@section('js')
<!-- DataTables  & Plugins -->
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status = 200) {
                ...
                $('#id').val(data.id)
                $('#e_domain_name_kh').val(data.domain_name_kh)
                $('#e_domain_name_en').val(data.domain_name_en)
