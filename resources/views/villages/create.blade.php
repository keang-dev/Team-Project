...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
    <form action="{{route('village.save')}}" id="formSave" class="modal-dialog" method="post" onsubmit="saveForm(event)" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="entity" value="villages">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="village">Photo <span class="text-danger"></span></label>
